...
# Inject About Developer button in top right
st.markdown("""
    <style>
    .about-dev {
        position: absolute;
    ...
    <div class='about-dev' onclick=\"window.open('https://jadav-gajanand-19.github.io/portfolio', '_blank')\">👨‍💻 About Developer</div>
...
with st.sidebar:
    ...
    st.markdown("Hi! I'm **Gajanand Jadav**, a passionate ML enthusiast and developer of this app.\n\n**Certifications:**\n- Machine Learning with Python (Coursera)\n- Data Science Foundation (IBM)\n\n**Other Projects:**\n- [RMS - Rainfall Management System](https://github.com/Jadav-Gajanand-19/VarshVaani)\n- [Titanic Survival Prediction](https://github.com/Jadav-Gajanand-19/Titanic-ML)\n\n**Portfolio:** [jadav-gajanand-19.github.io](https://jadav-gajanand-19.github.io/portfolio)")
    st.markdown("---")
...
st.markdown("""
    <div class='footer'>
        ...
        <div class='social-icons'>
            <a href='https://www.linkedin.com/in/jadav-gajanand-3aa946290/' target='_blank'><img src='https://cdn-icons-png.flaticon.com/512/174/174857.png'/></a>
            <a href='https://github.com/Jadav-Gajanand-19' target='_blank'><img src='https://cdn-icons-png.flaticon.com/512/25/25231.png'/></a>
            <a href='https://www.instagram.com/cadet_x9/' target='_blank'><img src='https://cdn-icons-png.flaticon.com/512/1384/1384031.png'/></a>
            <a href='https://www.kaggle.com/jadavgajanand' target='_blank'><img src='https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/kaggle.svg' style='width:32px;height:32px;'/></a>
            <a href='https://leetcode.com/u/Jadav_Gajanand/' target='_blank'><img src='https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/leetcode.svg' style='width:32px;height:32px;'/></a>
        </div>
    </div>
""", unsafe_allow_html=True)
